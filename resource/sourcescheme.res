...
Scheme
{
	Colors
	{
		...
		"TransparentBlack"									"20 20 20 250"
		"TransparentBlackInactive"							"15 15 15 235"
		"LightTransparentBlack"								"35 35 35 250"
		"LightTransparentBlackInactive"						"35 35 35 235"
	...
	BaseSettings
	{
		...
		CheckButton.HighlightFgColor						"Aqua"
		...
		ListPanel.SelectedBgColor							"Aqua"
		ListPanel.SelectedOutOfFocusBgColor					"TransparentBlackInactive"
		
		MainMenu.TextColor									"White"
		MainMenu.ArmedTextColor								"Aqua"
		MainMenu.Inset										"32"
		
		Menu.TextInset										"6"
		Menu.FgColor										"White"
		Menu.BgColor										"17 17 17 255"
		Menu.ArmedFgColor									"Aqua"
		Menu.ArmedBgColor									"Aqua"
		...
		TextEntry.TextColor									"Aqua"
		TextEntry.DisabledTextColor							"Aqua"
		TextEntry.SelectedBgColor							"Aqua"
		...
		SectionedListPanel.SelectedBgColor					"Aqua"
		...
		Console.TextColor									"Aqua"
		Console.DevTextColor								"White"
		
		NewGame.TextColor									"White"
		NewGame.FillColor									"0 0 0 255"
		NewGame.SelectionColor								"Aqua"
